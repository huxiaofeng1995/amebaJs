define(["require", "exports", "./define/LFCComponentElement", "./define/LogicletComponentElement", "./define/ArgElement"], function (require, exports, LFCComponentElement_1, LogicletComponentElement_1, ArgElement_1) {
    "use strict";
    var AbstractLFCDocumentParser = (function () {
        function AbstractLFCDocumentParser() {
        }
        ;
        AbstractLFCDocumentParser.prototype.parse = function (path, input, callback) {
        ...
        ;
        return AbstractLFCDocumentParser;
    }());
    exports.AbstractLFCDocumentParser = AbstractLFCDocumentParser;
});
//# sourceMappingURL=AbstractLFCDocumentParser.js.map